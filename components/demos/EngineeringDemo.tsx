...
export const EngineeringDemo: React.FC<DemoProps> = ({ functionId }) => {
  ...
  if (functionId === 'label_encoder') {
    return (
      <div className="flex flex-col items-center h-full pt-20">
        <button onClick={toggle} className="mb-8 px-4 py-2 bg-purple-600 rounded hover:bg-purple-500 transition-colors">
  ...
  if (functionId === 'fit_resample') {
    return (
      <div className="flex flex-col items-center h-full pt-20">
        <button onClick={toggle} className="mb-8 px-4 py-2 bg-pink-600 rounded hover:bg-pink-500 transition-colors">
