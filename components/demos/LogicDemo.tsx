...
export const LogicDemo: React.FC<DemoProps> = ({ functionId }) => {
    ...
    if (functionId === 'groupby') {
        return (
            <div className="flex flex-col items-center h-full pt-20">
                <button onClick={() => setGrouped(!grouped)} className="mb-8 px-4 py-2 bg-indigo-600 rounded hover:bg-indigo-500 transition-colors">
    ...
    if (functionId === 'concat') {
        return (
            <div className="flex flex-col items-center h-full pt-20">
                <button onClick={() => setConcatenated(!concatenated)} className="mb-8 px-4 py-2 bg-blue-600 rounded hover:bg-blue-500 transition-colors">
    ...
    if (functionId === 'quantile') {
        ...
        return (
            <div className="flex flex-col items-center h-full pt-20">
                <button onClick={() => setShowQuantiles(!showQuantiles)} className="mb-8 px-4 py-2 bg-yellow-600 rounded hover:bg-yellow-500 transition-colors">
