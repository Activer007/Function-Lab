...
export const TrainingDemo: React.FC<DemoProps> = ({ functionId }) => {
  ...
  if (functionId === 'predict') {
    ...
    return (
      <div className="flex flex-col items-center h-full pt-20">
        <button onClick={startPrediction} disabled={predicting} className="mb-8 px-6 py-2 bg-green-600 rounded-full hover:bg-green-500 disabled:opacity-50 transition-all">
